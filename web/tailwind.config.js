  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        'body-md': ['"Geist Variable"'],
        'body-lg': ['"Geist Variable"'],
        'headline-lg': ['"Geist Variable"'],
        'headline-xl': ['"Geist Variable"'],
        'headline-lg-mobile': ['"Geist Variable"'],
        'label-md': ['"Geist Mono Variable"'],
        'label-sm': ['"Geist Mono Variable"'],
      },
      fontSize: {
